...
import com.electro.model.request.client.ClientPreorderRequest;
import com.electro.model.reponse.client.ClientPreorderResponse;
...
public class ClientPreorderController {
    ...
    private final ClientPreorderMapper clientPreorderMapper;
    ...
    public ResponseEntity<ClientPreorderResponse> updatePreorder(@RequestBody ClientPreorderRequest request) {
        ClientPreorderResponse clientPreorderResponse = preorderRepository
                ...
                .orElseThrow(() -> new ResourceNotFoundException(
                        ResourceName.PREORDER.getResourceName(),
