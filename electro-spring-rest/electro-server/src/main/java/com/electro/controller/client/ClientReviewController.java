...
import com.electro.model.request.client.ClientReviewRequest;
import com.electro.model.reponse.client.ClientReviewResponse;
import com.electro.model.reponse.client.ClientSimpleReviewResponse;
...
public class ClientReviewController {
    ...
    public ResponseEntity<ClientReviewResponse> updateReview(@PathVariable Long id,
        ...
        ClientReviewResponse clientReviewResponse = reviewRepository.findById(id)
                ...
                .orElseThrow(() -> new ResourceNotFoundException(ResourceName.REVIEW.getResourceName(), FieldName.ID.getFieldName(), id));
