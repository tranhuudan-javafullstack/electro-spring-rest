...
import com.electro.model.enums.VerificationType;
...
public class VerificationServiceImpl implements VerificationService {
    ...
    public void resendRegistrationToken(Long userId) {
        ...
        if (verifyOpt.isPresent()) {
            ...
            verifyAndSendMail(userId, verification);
        } else {
            throw new VerificationException("User ID is invalid. Please try again!");
        }
    }

    private void verifyAndSendMail(Long userId, Verification verification) {
        String token = generateVerificationToken();
