...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers(SecurityConstants.IGNORING_API_PATHS.getPaths())
                .permitAll()
                .antMatchers(SecurityConstants.ADMIN_API_PATHS.getPaths())
                .hasAnyAuthority(SecurityConstants.Role.ADMIN.getRole(), SecurityConstants.Role.EMPLOYEE.getRole())
                .antMatchers(SecurityConstants.CLIENT_API_PATHS.getPaths())
                .hasAuthority(SecurityConstants.Role.CUSTOMER.getRole())
                .antMatchers("/**")
                .permitAll()
                .anyRequest()
                .authenticated();
