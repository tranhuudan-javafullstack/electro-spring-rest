...
import com.electro.model.reponse.client.ClientListedProductResponse;
import com.electro.model.reponse.client.ClientProductResponse;
...
import com.electro.model.projection.inventory.SimpleProductInventory;
...
public class ClientProductController {
    ...
    public ResponseEntity<ClientProductResponse> getProduct(@PathVariable String slug) {
        Product product = productRepository.findBySlug(slug)
                .orElseThrow(() -> new ResourceNotFoundException(ResourceName.PRODUCT.getResourceName(), FieldName.SLUG.getFieldName(), slug));
