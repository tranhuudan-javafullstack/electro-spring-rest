...
import com.electro.model.reponse.general.EventInitiationResponse;
...
public class ClientNotificationController {
    ...
    public ResponseEntity<NotificationResponse> updateNotification(@PathVariable Long id,
        ...
        NotificationResponse notificationResponse = notificationRepository
                ...
                .orElseThrow(() -> new ResourceNotFoundException(ResourceName.NOTIFICATION.getResourceName(), FieldName.ID.getFieldName(), id));
