...
import com.electro.model.request.client.ClientCartRequest;
import com.electro.model.reponse.client.ClientCartResponse;
import com.electro.model.request.client.ClientCartVariantKeyRequest;
...
public class ClientCartController {
    ...
    @PostMapping
    public ResponseEntity<ClientCartResponse> saveCart(@RequestBody ClientCartRequest request) throws RuntimeException {
        ...
        if (request.getCartId() == null) {
            ...
            cartBeforeSave = cartRepository.findById(request.getCartId())
                    ...
                    .orElseThrow(() -> new ResourceNotFoundException(ResourceName.CART.getResourceName(), FieldName.ID.getFieldName(), request.getCartId()));
        }
