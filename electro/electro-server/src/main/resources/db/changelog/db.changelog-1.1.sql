...
--rollback drop table customer_group;
--changeset huudan:16
...
--rollback drop table customer_resource;
--changeset huudan:17
...
--rollback drop table customer_status;
--changeset huudan: 18
...
--rollback drop table product_inventory_limit;
--changeset huudan: 32
...
--rollback drop table variant_inventory_limit;
--changeset huudan: 33
...
--rollback drop table count_variant;
--changeset huudan:36
...
--rollback drop table destination;
--changeset huudan:37
...
--rollback drop table docket_reason;
--changeset huudan:38
...
--rollback drop table storage_location;
--changeset huudan:39
...
--rollback drop table purchase_order_variant;
--changeset huudan:41
CREATE TABLE docket
(
    id                BIGINT AUTO_INCREMENT NOT NULL,
...
--rollback drop table docket_variant;
--changeset huudan:43
...
--rollback drop table order_resource;
--changeset huudan:45
...
--rollback drop table order_cancellation_reason;
--changeset huudan:46
CREATE TABLE `order`
(
    id                           BIGINT AUTO_INCREMENT NOT NULL,
...
--rollback drop table order_variant;
--changeset huudan:48
...
--rollback drop table cart_variant;
--changeset huudan:55
...
--rollback drop table promotion_product;
--changeset huudan:58
CREATE TABLE room
(
    id              BIGINT AUTO_INCREMENT NOT NULL,
...
--rollback drop table waybill_log;
--changeset huudan:63
...
--rollback drop table reward_strategy;
--changeset huudan:64
...
--rollback drop table reward_log;