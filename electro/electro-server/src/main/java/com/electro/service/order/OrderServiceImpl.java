...
import com.electro.config.paypal.PayPalHttpClient;
...
import com.electro.model.enums.OrderIntent;
import com.electro.model.enums.OrderStatus;
import com.electro.model.enums.PaymentLandingPage;
import com.electro.model.request.payment.PaypalRequest;
import com.electro.model.reponse.payment.PaypalResponse;
import com.electro.model.request.waybill.GhnCancelOrderRequest;
import com.electro.model.reponse.waybill.GhnCancelOrderResponse;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void cancelOrder(String code) {
        Order order = orderRepository.findByCode(code)
                .orElseThrow(() -> new ResourceNotFoundException(ResourceName.ORDER.getResourceName(), FieldName.ORDER_CODE.getFieldName(), code));
    ...
    public ClientConfirmedOrderResponse createClientOrder(ClientSimpleOrderRequest request) {
        ...
        Cart cart = cartRepository.findByUsername(username)
                .orElseThrow(() -> new ResourceNotFoundException(ResourceName.CART.getResourceName(), FieldName.USERNAME.getFieldName(), username));
    ...
    public void captureTransactionPaypal(String paypalOrderId, String payerId) {
        Order order = orderRepository.findByPaypalOrderId(paypalOrderId)
                .orElseThrow(() -> new ResourceNotFoundException(ResourceName.ORDER.getResourceName(), FieldName.PAYPAL_ORDER_ID.getFieldName(), paypalOrderId));
